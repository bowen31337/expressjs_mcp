...
app.get("/admin/users", authenticate, requireRole("admin"), (req: Request, res: Response) => {
  res.json({
...
app.delete("/admin/sessions", authenticate, requireRole("admin"), (req: Request, res: Response) => {
...
app.post("/admin/grant", authenticate, requireRole("admin"), (req: Request, res: Response) => {
...
app.get("/service/metrics", authenticate, requireRole("service"), (req: Request, res: Response) => {
  res.json({
    metrics: {
      requests: 1000,
      errors: 5,
