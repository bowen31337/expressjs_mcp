...
// Sample users data
const users = [
  { id: 1, name: 'Alice Johnson', email: 'alice@company.com', role: 'Senior Developer', department: 'Engineering' },
  { id: 2, name: 'Bob Smith', email: 'bob@company.com', role: 'UI/UX Designer', department: 'Design' },
  { id: 3, name: 'Carol Davis', email: 'carol@company.com', role: 'Product Manager', department: 'Product' },
  { id: 4, name: 'David Wilson', email: 'david@company.com', role: 'DevOps Engineer', department: 'Engineering' },
  { id: 5, name: 'Emma Brown', email: 'emma@company.com', role: 'Marketing Manager', department: 'Marketing' }
];
...
app.get('/api/users/stream', (req, res) => {
  ...
  const interval = setInterval(() => {
    ...
    const activities = ['logged in', 'updated profile', 'viewed dashboard', 'completed task', 'logged out'];
  ...
  try {
    ...
    if (method === 'tools/call') {
      ...
      if (mapping.path === '/api/users') {
        ...
        result = user;
      } else if (mapping.path === '/api/users/stream' || mapping.path === '/api/system/metrics') {
...
const mcp = new ExpressMCP(app, { 
  ...
  schemaAnnotations: {
    ...
    'GET /api/users/stream': {
      ...
      output: {
        type: 'string',
        description: 'Real-time stream of user activities with timestamps and departments'
      }
    },
    'GET /api/system/metrics': {
      ...
      output: {
        type: 'string',
        description: 'Real-time stream of system metrics including CPU, memory, and user activity'
      }
    }
  }
});
